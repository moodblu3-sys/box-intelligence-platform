  ...
  return (
    ...
    >
      <Text as="p" text03>
        ...
        will no longer be able to join Knot with this invite.
      </Text>
    </ConfirmationModalLayout>
  );
}
  ...
  return (
    ...
    >
      <Text as="p" text03>
        ...
        will immediately lose access to Knot. Their sessions and agents will be
  ...
  return (
    ...
    >
      <Text as="p" text03>
        ...
        will be permanently removed from Knot. All of their session history will
